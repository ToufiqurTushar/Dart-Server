...
abstract class Category
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      if (iconName != null) 'iconName': iconName,
      if (articles != null)
        'articles': articles?.toJson(valueToJson: (v) => v.toJsonForProtocol()),
    };
  }

  static CategoryInclude include({_i2.ArticleIncludeList? articles}) {
    return CategoryInclude._(articles: articles);
  }
...
class CategoryTable extends _i1.Table<int?> {
  ...
  _i2.ArticleTable? ___articles;

  _i1.ManyRelation<_i2.ArticleTable>? _articles;

  _i2.ArticleTable get __articles {
    if (___articles != null) return ___articles!;
    ___articles = _i1.createRelationTable(
      relationFieldName: '__articles',
      field: Category.t.id,
      foreignField: _i2.Article.t.$_categoryArticlesCategoryId,
  ...
  _i1.ManyRelation<_i2.ArticleTable> get articles {
    if (_articles != null) return _articles!;
    var relationTable = _i1.createRelationTable(
      relationFieldName: 'articles',
      field: Category.t.id,
      foreignField: _i2.Article.t.$_categoryArticlesCategoryId,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
    ...
    _articles = _i1.ManyRelation<_i2.ArticleTable>(
      tableWithRelations: relationTable,
      table: _i2.ArticleTable(
...
class CategoryInclude extends _i1.IncludeObject {
  CategoryInclude._({_i2.ArticleIncludeList? articles}) {
    _articles = articles;
  }

  _i2.ArticleIncludeList? _articles;

  @override
  Map<String, _i1.Include?> get includes => {'articles': _articles};
...
class CategoryAttachRepository {
  ...
  /// Creates a relation between this [Category] and the given [Article]s
  /// by setting each [Article]'s foreign key `_categoryArticlesCategoryId` to refer to this [Category].
  Future<void> articles(
    _i1.DatabaseSession session,
    Category category,
    List<_i2.Article> article, {
    _i1.Transaction? transaction,
  }) async {
    if (article.any((e) => e.id == null)) {
    ...
    var $article = article
        .map(
          (e) => _i2.ArticleImplicit(
            e,
            $_categoryArticlesCategoryId: category.id,
          ),
        )
        .toList();
    await session.db.update<_i2.Article>(
      $article,
      columns: [_i2.Article.t.$_categoryArticlesCategoryId],
      transaction: transaction,
    );
  }
}
...
class CategoryAttachRowRepository {
  ...
  /// Creates a relation between this [Category] and the given [Article]
  /// by setting the [Article]'s foreign key `_categoryArticlesCategoryId` to refer to this [Category].
  Future<void> articles(
    _i1.DatabaseSession session,
    Category category,
    _i2.Article article, {
    ...
    var $article = _i2.ArticleImplicit(
      article,
      $_categoryArticlesCategoryId: category.id,
    );
    await session.db.updateRow<_i2.Article>(
      $article,
      columns: [_i2.Article.t.$_categoryArticlesCategoryId],
      transaction: transaction,
    );
...
class CategoryDetachRepository {
  ...
  /// Detaches the relation between this [Category] and the given [Article]
  /// by setting the [Article]'s foreign key `_categoryArticlesCategoryId` to `null`.
  ///
